...
=== Http
include::{snippets}/login/modify-password/http-request.adoc[]
=== Request
include::{snippets}/login/modify-password/request-fields.adoc[]
=== Reponse
include::{snippets}/login/modify-password/response-fields.adoc[]
include::{snippets}/login/modify-password/response-body.adoc[]
...
=== Http
include::{snippets}/user/modify-password/http-request.adoc[]
=== Request
include::{snippets}/user/modify-password/request-fields.adoc[]
=== Response
include::{snippets}/user/modify-password/response-fields.adoc[]
include::{snippets}/user/modify-password/response-body.adoc[]
...
=== Http
include::{snippets}/user/modify-qna/http-request.adoc[]
=== Request
include::{snippets}/user/modify-qna/request-fields.adoc[]
=== Response
include::{snippets}/user/modify-qna/response-fields.adoc[]
include::{snippets}/user/modify-qna/response-body.adoc[]